      ...
      upload(req, res, async (err) => {
        ...
        res.send({
          ...
          user: {
            ...
            img: user.img_usr,
            des_pfl: user.Perfil?.des_pfl,
            prf_pfl: user.Perfil?.prf_pfl,
...
//         const fotoPath = foto ? `/uploads/api_user_${userId}/${foto.filename}` : null;
...
//         const fotoPath = foto ? `/uploads/api/${userId}/${foto.filename}` : null;
...
//       await userService.updateService(userId, avatar, bio);
//       const user = await userService.findByIdService(userId);
...
//       await userService.updateService(userId, avatar, background, bio);
//       const user = await userService.findByIdService(userId);
