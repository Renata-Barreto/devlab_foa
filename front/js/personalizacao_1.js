...
document.getElementById("personalizacaoForm").addEventListener("submit", async (event) => {
  ...
  // Removido o envio de canvasAvatar como Base64
  // Opcional: Se quiser enviar a cor do canvas, adicione como um campo simples
  // const canvasColor = document.getElementById("canvas").getContext("2d").fillStyle;
